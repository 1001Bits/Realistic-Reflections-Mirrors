#!/usr/bin/env python3
"""Run the local Fallout preview: python tools/mirror_creator/mirror_creator.py --open."""
...
SAMPLES = {
    'flat': ('Flat pane', 'placeable', ROOT/'examples/Flat.nif'),
    'hole': ('Pane with a hole', 'placeable', ROOT/'examples/Hole.nif'),
}
...
class Handler(BaseHTTPRequestHandler):
    server_version = 'FalloutMirrorCreator/1.0'
    ...
    def do_GET(self):
        ...
        if path == '/api/health':
            self.respond(200, dict(app='Mirror Creator for Fallout 4', version='1.0', game='fallout4', playableAddonExport=False,
    ...
    def do_POST(self):
        ...
        try:
            ...
            if path == '/api/close':
                self.respond(200, dict(closed=True))
